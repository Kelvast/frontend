...
const Stone_SLOPE_LOW_MID = tileData(Tile.Stone, TileHeight.SLOPE_LOW_MID);
const Stone_SLOPE_MID_HIGH = tileData(Tile.Stone, TileHeight.SLOPE_MID_HIGH);

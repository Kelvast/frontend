...
const { G, GD1, GD2, GD3, GD4, GD5, GI1, GI2, GI3, GI4, GI5, GI6 } = TILES; // prettier-ignore
...
export default {
  ...
  tiles: [
    ...
    [G, GI1, GI2, G, GD1, GD2, G, G, G, GD2, GD1, G, GI2, GI1, G, GI1],
    [G, G, GI1, GD1, GD1, G, G, G, G, G, GD1, GD1, GI1, G, G, GI1],

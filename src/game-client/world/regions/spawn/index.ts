...
const region: Region = {
  ...
  chunks: {
    ...
    "-1,1": { ...chunk_n1_1, chunkX: -1, chunkZ: 1, region: "spawn", objects: [], npcSpawns: [] },
    "-1,2": { ...chunk_n1_2, chunkX: -1, chunkZ: 2, region: "spawn", objects: [], npcSpawns: [] },
